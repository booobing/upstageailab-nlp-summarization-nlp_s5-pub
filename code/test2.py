...
config_data = {
    ...
    "inference": {
        "ckt_path": "/home/code/model_output/checkpoint-2490",  # 실제 모델 경로로 설정
        "result_path": "/home/prediction/",
...
def inference(config):
    ...
    output.to_csv(os.path.join(result_path, "output_new.csv"), index=False)
