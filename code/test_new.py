...
config_data = {
    ...
    "tokenizer": {
        ...
        "special_tokens": ['[INST]','[/INST]','#Person1#', '#Person2#', '#Person3#', '#PhoneNumber#', '#Address#', '#PassportNumber#']
    },
    "prompt": {
        "template": "[INST]배경 정보나 맥락을 제공하면서 인물의 행동과 결과를 중심으로 포괄적인 상황을 요약해주세요:[/INST]{dialogue}",
        "max_length": 512
    },
    "training": {
...
def prepare_train_dataset(config, preprocessor, data_path, tokenizer):
    train_file_path = os.path.join(data_path, 'fine_train_llm.csv')
